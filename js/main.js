...
function newNameValidation(){
   ...
   // signUpFailedAlert.classList.replace("show","hide");
    ...
    if(regex.test(signUpNameInput.value)==true){
      ...
      $(signUpNameInvalidAlert).fadeIn(700 , function(){$(signUpNameInvalidAlert).delay(3000).fadeOut(700)})
         return false;
    }
}
...
signUpMailInput.addEventListener("blur",newEmailValidation)
   ...
   if(regex.test(signUpMailInput.value)==true){
      ...
      if(hasala.includes(`false`)){
               ...
               $(registeredMailAlert).fadeIn(700 , function(){$(registeredMailAlert).delay(3000).fadeOut(700)})
      ...
      $(signUpEmailInvalidAlert).fadeIn(700 , function(){$(signUpEmailInvalidAlert).delay(3000).fadeOut(700)})
...
$(signUpPasswordInvalidAlert).fadeIn(700 , function(){$(signUpPasswordInvalidAlert).delay(4000).fadeOut(700)})
...
function logInEmailValidation(){
   ...
   if(regex.test(emailInput.value)==true){
      ...
      $(signInEmailInvalidAlert).fadeIn(700 , function(){$(signInEmailInvalidAlert).delay(3000).fadeOut(700)})
      return false;
...
if (passwordInput.value==""){
   ...
   $(signInPasswordInvalidAlert).fadeIn(700 , function(){$(signInPasswordInvalidAlert).delay(3000).fadeOut(700)})
...
$(signUpCompleteAlert).fadeIn(700 , function(){$(signUpCompleteAlert).delay(3000).fadeOut(700)})
// signUpFailedAlert.classList.replace("show","hide");
   ...
   //  signUpFailedAlert.classList.replace("hide","show");
    $(signUpFailedAlert).fadeIn(700 , function(){$(signUpFailedAlert).delay(3000).fadeOut(700)})
   //  signUpCompleteAlert.classList.replace("show","hide");
...
function userLogIn()
{
   ...
   if(logInEmailValidation()==true & logInPasswordValidation()==true ){
      ...
      if(checkInputs==true){
         ...
         $(IncorrectdAlert).fadeIn(700 , function(){$(IncorrectdAlert).delay(3000).fadeOut(700)})
         passwordInput.value = "";
